...
/**
 * CART — a Module Federation *remote*.
 *
 ...
 *   pnpm --filter @shop/cart watch    -> vite build --watch, real remoteEntry.js
 *                                           for the shell to consume (no HMR)
 *   pnpm --filter @shop/cart dev      -> plain vite dev of src/standalone.tsx,
